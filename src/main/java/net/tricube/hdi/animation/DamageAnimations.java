package net.tricube.hdi.animation;
        ...
        public void apply(Hologram hologram, Random random) {
            ...
            hologram.onUpdate(h -> {
                ...
                if (progress < 0.2f) {
                    ...
                    h.y = originalY + offsetY + (totalFloat * 0.2f * phaseProgress);
                    ...
                    h.alpha = 1.0f;
                    h.x = originalX + offsetX;
                    h.y = originalY + offsetY + totalFloat * (0.2f + 0.6f * floatEase);
                    h.z = originalZ + offsetZ;
                    ...
                    h.alpha = 1f - fadeEase;
                    h.x = originalX + offsetX;
                    h.y = originalY + offsetY + totalFloat * (0.8f + phaseProgress * 0.2f);
                    h.z = originalZ + offsetZ;
